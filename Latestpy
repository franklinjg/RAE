...
X = 500.0                    # This is the budget of the interest groups which is used in the computation of the optimal transfers.
...
matrix_inside_brackets = I - (phistar * G_transpose + Psi * np.diag(transposed_matrixJ - V_diag))
